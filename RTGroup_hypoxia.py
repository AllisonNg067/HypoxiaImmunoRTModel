...
# Creating the second plot with two sets of data on the same plot
  ...
  plt.tight_layout()
  figure_name = "new constrained alpha hypoxia RT tumor volume vs time " + str(i) + " .png"
...
dataFrame.to_csv("new constrained alpha hypoxia best parameters RT.csv", index=False)
std_devs.to_csv("new constrained alpha hypoxia errors RT.csv", index=False)
means.to_csv("new constrained alpha hypoxia means RT.csv", index=False)
