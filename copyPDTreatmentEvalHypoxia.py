...
file_name = 'smaller sampling range hypoxia RT ' + str(RT_fractions) + ' PD ' + str(PD_fractions) + ' e.csv'
...
#     print('k', k)
#     print(params[k])
args = [(k, params) for k in range(2000, min(iterations,2500))]
