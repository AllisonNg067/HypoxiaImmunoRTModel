...
nit_max = 100
nit_T = 100
param = np.array(pd.read_csv("new setonix hypoxia increased growth means control.csv"))
#print(param)
...
param_0 = param.copy()
#print(param_0)
param_0[3] = 0.35305886856017443
param_0[4] = 0.038689157423583934
param_0[5] = 1.3922011510635113
param_0[24] = 0  # ctla4 dose
param_0[37] = 0 
print(param_0)
#param[26] = 10
param_id = [3,4,5] #index of parameters to be changed
# param_0[2] = 0.15
# param_0[3] = 0.04
# param_0[4] = 0.4
# param_0[10] = 10**-12
...
# Creating the second plot with two sets of data on the same plot
  ...
  plt.tight_layout()
  figure_name = "new matched params hypoxia RT tumor volume vs time " + str(i) + " .png"
...
dataFrame.to_csv("new matched params hypoxia best parameters RT.csv", index=False)
std_devs.to_csv("new matched params hypoxia errors RT.csv", index=False)
means.to_csv("new matched params hypoxia means RT.csv", index=False)
